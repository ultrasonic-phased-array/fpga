...
#
# Generated by export_simulation on Sun Oct 08 12:46:44 CEST 2017
#
################################################################################
...
switch to the './z_turn.sh' script.
...
./z_turn.sh -noclean_files

For more information on the script, please type './z_turn.sh -help'.
