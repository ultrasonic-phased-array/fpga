...
HD_PWD='/home/niklas/xilinx/ultrasonic_7020_output/ultrasonic_7020.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log z_turn_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source z_turn_wrapper.tcl -notrace
