...
HD_PWD='/home/niklas/xilinx/ultrasonic_7020_output/ultrasonic_7020.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log z_turn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z_turn_wrapper.tcl
